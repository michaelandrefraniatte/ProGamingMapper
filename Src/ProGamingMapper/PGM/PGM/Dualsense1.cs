...
namespace DualSense1API
{
    /// <summary>
    /// Interaction logic for DualSense1 controllers.
    /// </summary>
    public class DualSense1
    {
        // IO parameters
        ...
        private DualSense1(IDevice underlyingDevice, int? writeBufferSize)
        {
        ...
        /// expected that you will only use the <see cref="DualSense1"/> instance passed as an argument to 
        ...
        /// <returns>A parsed <see cref="DualSense1Touch"/>.</returns>
        private static DualSense1Touch ReadTouchpad(byte[] bytes)
        {
        ...
        /// </summary>
        public static DualSense1Touch Touchpad1 { get; private set; }

        /// <summary>
        /// The second touch point.
        /// </summary>
        public static DualSense1Touch Touchpad2 { get; private set; }
        ...
        public static DualSense1 EnumerateControllers(string vendor_id, string product_id, string label_id)
        {
            foreach (ConnectedDeviceDefinition deviceDefinition in ListDevices(vendor_id, product_id, label_id))
            {
                ...
                return new DualSense1(device, deviceDefinition.WriteBufferSize);
            }
            return null;
        }

        /// <summary>
        /// A handler for a state polling IO event. The sender has the <see cref="DualSense1InputState"/>
        /// from the most recent poll, and can be used to update the next
        /// <see cref="DualSense1OutputState"/>.
        /// </summary>
        /// <param name="sender">The <see cref="DualSense1"/> instance that was just polled.</param>
        public delegate void StatePolledHandler(DualSense1 sender);
    ...
    /// </summary>
    internal static class DualSense1ByteConverterExtensions
    {
        /// <summary>
    ...
    /// <summary>
    /// One of the DualSense1's 2 touch points. The touchpad is 1920x1080, 0-indexed.
    /// </summary>
    public struct DualSense1Touch
    {
        /// <summary>
