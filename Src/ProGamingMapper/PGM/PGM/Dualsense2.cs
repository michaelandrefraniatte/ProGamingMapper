...
namespace DualSense2API
{
    /// <summary>
    /// Interaction logic for DualSense2 controllers.
    /// </summary>
    public class DualSense2
    {
        // IO parameters
        ...
        private DualSense2(IDevice underlyingDevice, int? writeBufferSize)
        {
        ...
        /// expected that you will only use the <see cref="DualSense2"/> instance passed as an argument to 
        ...
        /// <returns>A parsed <see cref="DualSense2Touch"/>.</returns>
        private static DualSense2Touch ReadTouchpad(byte[] bytes)
        {
        ...
        /// </summary>
        public static DualSense2Touch Touchpad1 { get; private set; }

        /// <summary>
        /// The second touch point.
        /// </summary>
        public static DualSense2Touch Touchpad2 { get; private set; }
        ...
        public static DualSense2 EnumerateControllers(string vendor_id, string product_id, string label_id, bool similar)
        {
            int similarcount = 0;
            foreach (ConnectedDeviceDefinition deviceDefinition in ListDevices(vendor_id, product_id, label_id))
            {
                if (!similar)
                {
                    ...
                    return new DualSense2(device, deviceDefinition.WriteBufferSize);
                }
                else
                {
                    if (similarcount == 1)
        ...
        /// <summary>
        /// A handler for a state polling IO event. The sender has the <see cref="DualSense2InputState"/>
        /// from the most recent poll, and can be used to update the next
        /// <see cref="DualSense2OutputState"/>.
        /// </summary>
        /// <param name="sender">The <see cref="DualSense2"/> instance that was just polled.</param>
        public delegate void StatePolledHandler(DualSense2 sender);
    ...
    /// </summary>
    internal static class DualSense2ByteConverterExtensions
    {
        /// <summary>
    ...
    /// <summary>
    /// One of the DualSense2's 2 touch points. The touchpad is 1920x1080, 0-indexed.
    /// </summary>
    public struct DualSense2Touch
    {
        /// <summary>
