...
namespace DualShock41API
{
    /// <summary>
    /// Interaction logic for DualShock41 controllers.
    /// </summary>
    public class DualShock41
    {
        // IO parameters
        ...
        private DualShock41(IDevice underlyingDevice, int? writeBufferSize)
        {
        ...
        /// expected that you will only use the <see cref="DualShock41"/> instance passed as an argument to 
        ...
        /// <returns>A parsed <see cref="DualShock41Touch"/>.</returns>
        private static DualShock41Touch ReadTouchpad(byte[] bytes)
        {
        ...
        /// </summary>
        public static DualShock41Touch Touchpad1 { get; private set; }

        /// <summary>
        /// The second touch point.
        /// </summary>
        public static DualShock41Touch Touchpad2 { get; private set; }
        ...
        public static DualShock41 EnumerateControllers(string vendor_id, string product_id, string label_id)
        {
            foreach (ConnectedDeviceDefinition deviceDefinition in ListDevices(vendor_id, product_id, label_id))
            {
                ...
                return new DualShock41(device, deviceDefinition.WriteBufferSize);
            }
            return null;
        }

        /// <summary>
        /// A handler for a state polling IO event. The sender has the <see cref="DualShock41InputState"/>
        /// from the most recent poll, and can be used to update the next
        /// <see cref="DualShock41OutputState"/>.
        /// </summary>
        /// <param name="sender">The <see cref="DualShock41"/> instance that was just polled.</param>
        public delegate void StatePolledHandler(DualShock41 sender);
    ...
    /// </summary>
    internal static class DualShock41ByteConverterExtensions
    {
        /// <summary>
    ...
    /// <summary>
    /// One of the DualShock41's 2 touch points. The touchpad is 1920x1080, 0-indexed.
    /// </summary>
    public struct DualShock41Touch
    {
        /// <summary>
