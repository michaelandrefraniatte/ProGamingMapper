    ...
    public partial class Form1 : Form
    {
        ...
        private void Controller1ProcessIMU()
        {
            if (gyromode == 1 | gyromode == 2)
            {
                ...
                gyr_gController1.Y = -(float)Math.Round((Int16)Controller1ThumbRightY / 2222222222f * 3f, 7);
                gyr_gController1.Z = -(float)Math.Round((Int16)Controller1ThumbRightX / 2222222222f * 3f, 7);
        ...
        private void Controller2ProcessIMU()
        {
            if (gyromode == 1 | gyromode == 2)
            {
                ...
                gyr_gController2.Y = -(float)Math.Round((Int16)Controller2ThumbRightY / 2222222222f * 3f, 7);
                gyr_gController2.Z = -(float)Math.Round((Int16)Controller2ThumbRightX / 2222222222f * 3f, 7);
        ...
        public static Quaternion GetVector(Vector3 i_, Vector3 j_, Vector3 k_)
        {
            Vector3 v1 = new Vector3(j_.X, i_.X, k_.X);
            Vector3 v2 = -new Vector3(j_.Z, i_.Z, k_.Z);
        ...
        static int ProcessStateLogic(DualSenseInputState dss, int wheelPos)
        {
            ...
            if (gyromode == 1 | gyromode == 2)
            {
                gyr_gPS5.X = (float)Math.Round(dss.Gyro.Z / 2222222222f * 3f, 7);
                gyr_gPS5.Y = -(float)Math.Round(dss.Gyro.X / 2222222222f * 3f, 7);
                gyr_gPS5.Z = -(float)Math.Round(dss.Gyro.Y / 2222222222f * 3f, 7);
            }
            else
            {
