...
namespace MouseControlTester
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (slowing >= " + textBox1.Text + @")
            {
                MouseBrink((int)(-mousex / " + textBox2.Text + @" - (mousex > 0 ? 1 : -1) * " + textBox3.Text + @"), (int)(mousey / " + textBox2.Text + @" + (mousey > 0 ? 1 : -1) * " + textBox3.Text + @"));
                slowing = 0;
            }";
            MessageBox.Show(message);
            Clipboard.SetDataObject(message, true);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (slowing >= " + textBox1.Text + @")
            {
                MouseMW3((int)(-mousex / " + textBox2.Text + @" - (mousex > 0 ? 1 : -1) * " + textBox3.Text + @"), (int)(mousey / " + textBox2.Text + @" + (mousey > 0 ? 1 : -1) * " + textBox3.Text + @"));
                slowing = 0;
            }";
            MessageBox.Show(message);
            Clipboard.SetDataObject(message, true);
